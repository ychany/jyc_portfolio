          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <motion.a
                ...
                className="flex items-center gap-1.5 rounded-lg border border-teal-500/60 px-3 py-1.5 text-sm font-medium text-teal-600 transition-colors hover:bg-teal-50 dark:text-teal-400 dark:hover:bg-teal-900/30"
                whileHover={{ y: -2 }}
                whileTap={{ scale: 0.95 }}
                title="이력서 PDF 다운로드"
              >
