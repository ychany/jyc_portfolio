...
const techTagColors: Record<string, string> = {
  ...
  "Next.js": "bg-black/10 text-black dark:bg-white/20 dark:text-white",
  ...
  Zustand: "bg-[#764ABC]/20 text-[#764ABC]",
  "Vapor UI": "bg-[#0064FF]/20 text-[#0064FF]",
  "Kakao Map API": "bg-[#FEE500]/20 text-[#FEE500]",
  Vercel: "bg-black/10 text-black dark:bg-white/20 dark:text-white",
                    ...
                    <span key={link.label} className="contents">
                      {link.demo && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-2 px-5 py-2.5 bg-teal-600 text-white font-medium rounded-full hover:bg-teal-700 transition-colors cursor-pointer"
                        >
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      {link.github && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-2 px-5 py-2.5 bg-gray-700 text-white font-medium rounded-full hover:bg-gray-600 transition-colors cursor-pointer dark:border dark:border-white/50"
                        >
                          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
