...
import { aboutData, profileData } from "@/data/portfolio";
...
const icons: Record<string, React.ReactNode> = {
  ...
  education: (
    <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
      <path d="M21.71 7.29l-9-5c-.4-.22-.88-.22-1.28 0l-9 5c-.47.26-.47.94 0 1.2L5 10.05V16c0 .55.45 1 1 1s1-.45 1-1v-4.85l2 1.1V17c0 .55.22 1.07.61 1.45l.05.05c.32.31.72.5 1.15.5H17c.43 0 .83-.19 1.15-.5l.05-.05c.39-.38.61-.9.61-1.45v-4.75l2.71-1.5c.47-.26.47-.94-.01-1.21zM12 15.28L6.56 12.5l5.44-3 5.44 3L12 15.28zM17 17H9.5c-.28 0-.5-.22-.5-.5s.22-.5.5-.5H17v1z" />
    </svg>
  ),
};
