  ...
  return (
    <section id="archiving" className="py-16 md:py-24 bg-[#1a1a1a]">
      <div className="max-w-4xl mx-auto px-6">
        {/* Title */}
        <motion.h2
          className="text-2xl md:text-3xl font-bold mb-8 text-white relative inline-block"
          ...
          {archivingData.map((archive, index) => (
            <FadeIn key={archive.name} delay={0.1 * index}>
              <motion.a
                ...
                className="flex items-center gap-3 bg-white/10 hover:bg-white/20 rounded-full px-5 py-3 transition-colors group"
              ...
              >
                ...
                <svg className="w-4 h-4 text-gray-400 group-hover:text-teal-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
