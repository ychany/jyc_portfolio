            ...
            >
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white">{activityData[0].organization}</h3>
                    <p className="text-gray-600 dark:text-gray-300">{activityData[0].role}</p>
                  </div>
                </div>
                <div className="md:text-right">
                  <span className="inline-block px-4 py-2 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 font-medium rounded-full text-sm">
                    {activityData[0].period}
                  </span>
                </div>
              </div>
              ...
              {activityData[0].links && (
                <div className="mt-4 ml-16 flex gap-3">
                  {activityData[0].links.website && (
                    <a
                      href={activityData[0].links.website}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 px-4 py-2 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 rounded-full text-sm font-medium hover:bg-indigo-200 dark:hover:bg-indigo-900/50 transition-colors"
                    >
                  ...
                  {activityData[0].links.github && (
                    <a
                      href={activityData[0].links.github}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full text-sm font-medium hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
                    >
